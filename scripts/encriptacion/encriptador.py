...
def getGrillEncryptor(tam_x, tam_y):
    ...
    epocs = 200
    initial_key = {'key': np.copy(gameState), 'epocs': epocs, 'tam_x': nxC, 'tam_y': nyC}
    ...
    while epocs != 0:
        ...
        for y in range(0,nxC):
            for x in range(0,nyC):
                ...
                # Regla 3: Una celula viva con 5 vecinos vivos, nace como una celula buena
        ...
        epocs -= 1
    return gameState, initial_key


def getGrillDecryptor(inital_key):
    nxC, nyC = inital_key['tam_x'], inital_key['tam_y']
    epocs = inital_key['epocs']
    gameState = inital_key['key']
